...
namespace Day02CST
{
    public class CSharpType
    {
        public static void Display()
        {
            ...
            //Straight underscore line: unicode, length 
            WriteLine(RepeatIt('\u2500', 100));
            //Table header: index, length - minus value puts space after string
            WriteLine("{0,-10} {1,-20} {2,-50} {3,-5}", "Type", "CLR Type", "Range", "Default Value");
            WriteLine(RepeatIt('\u2500', 100));
            foreach (var dataType in dataTypes)
                WriteLine("{0,-10} {1,-20} {2,-50} {3,-5}", dataType.Type, dataType.CLRType, dataType.Range, dataType.DefaultValue);
            WriteLine(RepeatIt('\u2500', 100));
        }
