...
namespace Day02
{
    ...
    {
        //Get & Set Methods - get numbers from user
        ...
        private void AssignmentOperators()
        {
            ...
            WriteLine($"Operator '=' (assignment): {nameof(result)}={nameof(Num1)} + {nameof(Num2)} where {nameof(result)} contains value: {Num1 + Num2}");
    ...
    public struct Coordinate
    {
        ...
        //Override bool Object which returns its function
